...
// ********************************************************************
//
// $Id: KinichAhauUserTrackInformation.hh 68752 2013-04-05 10:23:47Z gcosmo $
//
/// \file optical/KinichAhau/include/KinichAhauUserTrackInformation.hh
/// \brief Definition of the KinichAhauUserTrackInformation class
//
#include "G4VUserTrackInformation.hh"
#include "globals.hh"

#ifndef KinichAhauUserTrackInformation_h
#define KinichAhauUserTrackInformation_h 1

enum KinichAhauTrackStatus { active=1, hitPMT=2, absorbed=4, boundaryAbsorbed=8,
                      hitSphere=16, inactive=14};

/*KinichAhauTrackStatus:
...
class KinichAhauUserTrackInformation : public G4VUserTrackInformation
{
  public:

    KinichAhauUserTrackInformation();
    virtual ~KinichAhauUserTrackInformation();
